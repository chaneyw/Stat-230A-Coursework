rm(list=ls())
setwd('/home/wes/Desktop/Stat 230A/HW2/')
load('family.rda')
...
regline()
## BMI seems to get smaller with increasing height, holding weight constant. It tends to get larger with increasing weight while holding height constant.
## This makes sense because BMI is calculated using a ratio of height to weight.
